...
public class TestConfig {
	...
	public static String dbConnectionUrl = "jdbc:jtds:sqlserver://localhost:1433;DatabaseName=RAJENDRA-LENOVO";
	public static String dbUserName = "RAJENDRA-LENOVO\\Rajendra Prasad";
...
//	public static String mysqldriver="com.mysql.jdbc.Driver";
	...
	public static String mysqlpassword = "Prasad_990";
	public static String mysqlurl = "jdbc:mysql://localhost:3306/prasad";
